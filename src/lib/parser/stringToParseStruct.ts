...
// Label is the "century"/"cen"/"Cen" part of the string
const century = (century: string, _label: string, era: string) => {
...
// Label is the "millenium"/"mil"/"m" part of the string
const millenium = (millenium: string, _label: string, era: string) => {
...
export const stringToParseStruct = (str?: string): ParseResult | undefined => {
