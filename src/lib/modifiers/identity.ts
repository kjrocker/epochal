...
const patterns = [
  ...
  /^d\s+a\s+t\s+e\s+d\s+/,
  /^(originally|first)\s+published\s+/,
  /(first\spublished|probably|possibly|likely|about|patented|suggested|check|originally|publication|primarily|issued|reissued)\s+/,
