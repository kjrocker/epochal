...
describe("ordinalMonthAndYear", () => {
  ...
  test.each([
    ...
    ["1st month of 1919", { month: 1, year: 1919 }],
    ["2nd month of 2024", { month: 2, year: 2024 }],
    ["3rd month of 1500", { month: 3, year: 1500 }],
    ["4th month of 1999", { month: 4, year: 1999 }],
    ...
    // Ordinal word formats. Now handled by 'clean'
    ...
    // Year-first ordinal word formats. Now handled by 'clean'
